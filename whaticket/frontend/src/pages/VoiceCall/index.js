...
const VoiceCall = () => {
	...
	return (
		<div className={classes.root}>  
			...
			<Paper className={classes.paper}>
			<h3><span role="img" aria-label="warning">⚠️</span> Ligação Tefefônica VOIP.</h3>
			</Paper>
			<Paper className={classes.paper}>
			<h3><span role="img" aria-label="phone">📱</span> Essa funcionalidade depende de configuração e tarifas de ligações direto com a Magnetron Telecomunicações.</h3>
			</Paper>
