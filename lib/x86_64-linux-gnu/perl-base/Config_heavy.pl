...
config_arg7='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -fdebug-prefix-map=/build/perl-Ox33E8/perl-5.30.0=. -fstack-protector-strong -Wformat -Werror=format-security'
...
src='/build/perl-Ox33E8/perl-5.30.0'
ssizetype='ssize_t'
st_ino_sign='1'
st_ino_size='8'
